...
/*
 * Gets Terraform symbols -- ignores comments, strings, keywords
 */
...
%%
%public
%class TerraformSymbolTokenizer
%extends TerraformLexer
%unicode
%int
%char
...
%{
    ...
    /**
     * Resets the Terraform tracked state; {@inheritDoc}
     */
    @Override
    public void reset() {
        super.reset();
...
// Terraform.lexh comes after HCL so that Terraform macros supersede.
%include ../hcl/HCL.lexh
%include Terraform.lexh

%%
// TerraformProductions.lexh comes first so that its expressions are preferred.
%include TerraformProductions.lexh
%include ../hcl/HCLProductions.lexh
