...
public class JavaScriptAnalyzer extends AbstractSourceCodeAnalyzer {
    ...
    private final JavaScriptSymbolTokenizer cref = new JavaScriptSymbolTokenizer(AnalyzerGuru.dummyR);
    private final JavaScriptXref xref = new JavaScriptXref(AnalyzerGuru.dummyR);
