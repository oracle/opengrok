...
public class PythonAnalyzer extends AbstractSourceCodeAnalyzer {
    ...
    private final PythonSymbolTokenizer cref = new PythonSymbolTokenizer(AnalyzerGuru.dummyR);
    private final PythonXref xref = new PythonXref(AnalyzerGuru.dummyR);
