...
public class PoshAnalyzerFactory extends FileAnalyzerFactory {
    ...
    public PoshAnalyzerFactory() {
        super(null, null, SUFFIXES, null, null, "text/plain", Genre.PLAIN, name);
    }

    @Override
    protected FileAnalyzer newAnalyzer() {
        return new PoshAnalyzer(this);
    }
    ...
    public void writeXref(Reader in, Writer out, Definitions defs,
        ...
        throws IOException {
        PoshAnalyzer.writeXref(in, out, defs, annotation, project);
    }
}
