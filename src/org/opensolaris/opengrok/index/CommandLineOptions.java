...
public class CommandLineOptions {
    ...
    public CommandLineOptions() {
        ...
        options.add(new Option('B', "url", "Base URL of the user Information provider. Default: \"http://www.myserver.org/viewProfile.jspa?username=\". Use \"none\" to disable link."));
