...
public class AuthorizationFilter implements ContainerRequestFilter {
    ...
    private String[] getProjects() {
        ...
        // if no projects are specified then it means that all projects are wanted
        Map<String, Project> projectsMap = env.getProjects();
        if (projectsMap != null) {
            return projectsMap.keySet().toArray(new String[0]);
        }
