...
public class PoshXrefTest {
    ...
    private void writeAndCompare(String sourceResource, String resultResource,
        ...
        writePowerShellXref(new PrintStream(baos), res, defs);
        res.close();
        ...
        assertLinesEqual("PowerShel xref", expected, gotten);
    }

    private void writePowerShellXref(PrintStream oss, InputStream iss,
        Definitions defs)
        throws IOException {
