    ...
    <%
{
    ...
    %>
    <% if (!messages.isEmpty()) { %>
    <span class="note-<%= MessagesUtils.getCssClass(cfg.getProject().getName(), MessagesContainer.MESSAGES_MAIN_PAGE_TAG) %> important-note">
    <% } %>
    ...
    <span class="note-<%= MessagesUtils.getCssClass(cfg.getProject().getName(), MessagesContainer.MESSAGES_MAIN_PAGE_TAG) %> important-note important-note-rounded"
